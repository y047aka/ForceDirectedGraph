...
var author$project$Main$initializeNode = function (ctx) {
	return {
...
var author$project$SampleData$miserablesGraph = A2(
...
var author$project$Main$init = function (_n0) {
	...
	var graph = A2(elm_community$graph$Graph$mapContexts, author$project$Main$initializeNode, author$project$SampleData$miserablesGraph);
...
var author$project$Main$updateNode = F2(
	function (_n0, nodeCtx) {
		...
		return A2(
			author$project$Main$updateContextWithValue,
			nodeCtx,
			_Utils_update(
				nodeValue,
				{x: x, y: y}));
				...
				if (drag.$ === 'Nothing') {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								graph: A2(author$project$Main$updateGraphWithList, graph, list),
								simulation: newState
							}),
						elm$core$Platform$Cmd$none);
				} else {
						...
						_Utils_update(
							model,
							{
								graph: A3(
									...
									A2(author$project$Main$updateGraphWithList, graph, list)),
								simulation: newState
							}),
						elm$core$Platform$Cmd$none);
				}
...
var author$project$Main$siteFooter = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					elm_community$typed_svg$TypedSvg$Core$text('© 2019 y047aka')
				]))
		]));
...
var author$project$Main$siteHeader = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					elm_community$typed_svg$TypedSvg$Core$text('Force Directed Graph')
				]))
		]));
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				author$project$Main$onMouseDown(node.id),
...
var author$project$Main$viewForce = function (model) {
	return A2(
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								author$project$Main$viewForce(model)
							]))
					])),
